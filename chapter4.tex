...
treating the \mv spectral sequence, we discuss the algorithm in terms of a topological analogue, the \mvb{}.  For completeness, we provide a description
of the \mv spectral sequence, in Chapter~\ref{chap:mvss}
