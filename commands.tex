...
\newcommand{\toruspicture}[1]{
 \begin{scope}[shift={(262,145)}]
 \begin{axis} [axis lines=none,view={0}{60},scale=.35]
            \addplot3 [surf,
                 draw=gray,
                 fill=#1,
                shader=flat,
 ...
 \newcommand{\mickeymouse}[1]{

     \draw[color=#1, ultra thick] (448.0, 200) arc (0:360:20) ;
        \draw[color=#1, ultra thick] (401.5, 200) arc (0:360:20) ;
        \shade [ball color=#1]  (403.5,178) circle [radius=1cm];
 }
 \newcommand{\moebiustrip}[1]{
    \begin{scope}[shift={(445,125)}]
\begin{axis}[hide axis, view={40}{40}, scale=.5]
\addplot3 [surf, shader=flat,
    ...
    {0.5*y*sin(x/2)});
%\addplot3 [samples=50, domain=-145:180, samples y=0, ultra thick] (
%    {cos(x)},
%    {sin(x)},
%    {0});
\end{axis}
